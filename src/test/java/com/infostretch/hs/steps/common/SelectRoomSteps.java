...
public class SelectRoomSteps {
    ...
    public void captureTheRoomDetailsAndOption() {
        ...
        String roomCategoryDiscountedPrice = CommonStep
            .getText("hotel.room.category.detail.txt.discountedprice");
        String roomCategoryOriginalPrice = CommonStep
            .getText("hotel.room.category.detail.txt.originalprice");

        ConfigurationManager.getBundle()
            .setProperty(Constants.SELECTED_ROOM_CATEGORY_NAME, roomCategoryName);
        ConfigurationManager.getBundle()
            .setProperty(Constants.SELECTED_ROOM_CATEGORY_DISCOUNTEDPRICE,
                roomCategoryDiscountedPrice);
        ConfigurationManager.getBundle()
            .setProperty(Constants.SELECTED_ROOM_CATEGORY_ORIGINALPRICE, roomCategoryOriginalPrice);
