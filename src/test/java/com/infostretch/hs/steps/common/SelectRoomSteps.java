...
public class SelectRoomSteps {
    ...
    public void captureTheRoomDetailsAndOption() {
    	...
    	ConfigurationManager.getBundle().setProperty(Constants.SELECTED_ROOM_CATEGORY_DISCOUNTEDPRICE,roomCategoryDiscountedPrice);
    	ConfigurationManager.getBundle().setProperty(Constants.SELECTED_ROOM_CATEGORY_ORIGINALPRICE,roomCategoryOriginalPrice);
